...
$lien=$_SESSION['email'];
$requete=$db->query("SELECT * FROM users WHERE email='$lien'");
...
<body>
  ...
  {
                    echo "<br>Prenom: ".$resultat['prenom'] ."<br>Nom: ".$resultat['nom']."<br>";
                    echo "Email: ".$resultat['email'] ."<br>Mot de passe: ".$resultat['passwords'] ;
                }
                     ?>
